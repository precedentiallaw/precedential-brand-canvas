...
export default function DownloadsSection() {
  ...
  return (
    <section id="downloads" className="py-20 px-4 bg-precedential-black text-precedential-white">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-20">
          {downloads.map((download, index) => (
            <div key={index} className="bg-precedential-black border border-precedential-gold/30 p-6 rounded-md flex flex-col items-center text-center reveal-on-scroll" style={{animationDelay: `${index * 0.1}s`}}>
        ...
        <div className="mt-16 reveal-on-scroll mockup-shadow">
          <img 
            src="/lovable-uploads/685e25d1-de9c-4e15-a32b-ab5348f8c677.png" 
            alt="Precedential Final Mockup" 
