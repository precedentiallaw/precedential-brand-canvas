  ...
  return <section id="logo-usage" className="py-20 px-4 bg-precedential-white text-precedential-black">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
          <div className="p-8 rounded-md flex items-center justify-center reveal-on-scroll mockup-shadow bg-slate-50">
            <img src="/lovable-uploads/9954224c-5a1a-40d0-abaf-b9fa4b664494.png" alt="Precedential Horizontal Logo" className="max-w-full max-h-40 object-contain" />
          </div>
