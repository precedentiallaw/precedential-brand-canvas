...
export default function LogoUsageSection() {
  return (
    <section id="logo-usage" className="py-20 px-4 bg-precedential-white text-precedential-black">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16">
          <div className="bg-precedential-black p-8 rounded-md flex items-center justify-center reveal-on-scroll mockup-shadow">
            <img 
              src="/lovable-uploads/9954224c-5a1a-40d0-abaf-b9fa4b664494.png" 
              alt="Precedential Horizontal Logo" 
          ...
          <div className="bg-precedential-black p-8 rounded-md flex items-center justify-center reveal-on-scroll mockup-shadow">
            <img 
              ...
              alt="Precedential Vertical Logo" 
              className="max-w-full max-h-40"
            />
          </div>
        </div>
        ...
        <div className="mb-10 bg-precedential-black p-8 rounded-md flex items-center justify-center reveal-on-scroll mockup-shadow">
          <img 
            src="/lovable-uploads/c50bf003-bf6a-4e4d-93cb-112f7b3c4657.png" 
            alt="Precedential Icon Only" 
        ...
        <div className="mt-16 reveal-on-scroll mockup-shadow">
          <img 
            src="/lovable-uploads/c1763d84-16f1-43f1-93c9-27c470973367.png" 
            alt="Precedential Logo Mockup" 
