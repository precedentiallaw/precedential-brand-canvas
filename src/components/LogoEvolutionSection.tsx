...
export default function LogoEvolutionSection() {
  ...
  return <section id="logo-evolution" className="py-20 px-4 bg-precedential-white text-precedential-black">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mb-16">
          {evolutionSteps.map((step, index) => <div key={step.id} className={`flex flex-col md:flex-row items-center gap-8 mb-16 ${index % 2 === 1 ? 'md:flex-row-reverse' : ''} reveal-on-scroll`}>
              <div className="w-full md:w-1/2 flex justify-center">
                <div className="p-6 rounded-md cursor-pointer bg-white hover:shadow-lg transition-shadow" onClick={() => openModal(step.image)}>
        ...
        <div className="mt-16 reveal-on-scroll cursor-pointer" onClick={() => openModal("/lovable-uploads/7b6299ae-a241-4a60-a31f-220ccd901a88.png")}>
          <img src="/lovable-uploads/7b6299ae-a241-4a60-a31f-220ccd901a88.png" alt="Precedential Logo Mockup 3" className="w-full h-auto rounded-md object-scale-down" />
        </div>
      </div>
