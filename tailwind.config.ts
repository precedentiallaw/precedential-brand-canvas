	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'slide-in-delay-1': 'slide-in 0.7s ease-out 0.1s forwards',
				'slide-in-delay-2': 'slide-in 0.7s ease-out 0.2s forwards',
				'slide-in-delay-3': 'slide-in 0.7s ease-out 0.3s forwards',
